...
public class Bbs04Dao {
	...
	public void reAdd2(String sub, String content, int ref, int seq, int lev) throws SQLException{
		String sql1="update bbs04 set re_seq=re_seq+1 where re_ref=?";
		String sql2="insert into bbs04 values (bbs04_seq.nextval, ?, ?, sysdate, ?, ?, ?)";
		Connection conn=null;
		PreparedStatement pstmt= null;
		try{
			conn=MyOracle.getConnection();
